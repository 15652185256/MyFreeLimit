//
//  CategoryNewsListViewController.swift
//  MyFreeLimit
//
...
class CategoryNewsListViewController: RootViewController {
    ...
    override func loadData() {
        ...
        self.stringUrl = "\(self.strUrl)?page=\(self.NewsListPage)&number=7&cate_id=\(self.cateID)"
